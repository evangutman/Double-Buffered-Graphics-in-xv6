...
int main(void) {
   ...
   f:	51                   	push   %ecx
	...
	int x = 320;
	int y = 240;
  10:	be f0 00 00 00       	mov    $0xf0,%esi
...
int main(void) {
	int k;
	int x = 320;
  15:	bb 40 01 00 00       	mov    $0x140,%ebx
#include "types.h"
#include "user.h"
...
int main(void) {
  1a:	83 ec 0c             	sub    $0xc,%esp
	...
	init_graphics();
  1d:	e8 b0 03 00 00       	call   3d2 <init_graphics>
	//test_draw_line();
	draw_pixel(x, y, color);	//draw pixel in the middle
  22:	83 ec 04             	sub    $0x4,%esp
  25:	6a 04                	push   $0x4
  27:	68 f0 00 00 00       	push   $0xf0
  2c:	68 40 01 00 00       	push   $0x140
  31:	e8 bc 03 00 00       	call   3f2 <draw_pixel>
	blit();
  36:	e8 c7 03 00 00       	call   402 <blit>
  3b:	83 c4 10             	add    $0x10,%esp
  3e:	66 90                	xchg   %ax,%ax
	while(1){
		k = getkey();
  40:	e8 9d 03 00 00       	call   3e2 <getkey>
		if(k == -1){
  ...
  48:	74 37                	je     81 <main+0x81>
			...
			switch (k) {
  4a:	83 f8 e3             	cmp    $0xffffffe3,%eax
  4d:	74 61                	je     b0 <main+0xb0>
  4f:	7e 3f                	jle    90 <main+0x90>
  51:	83 f8 e4             	cmp    $0xffffffe4,%eax
  54:	74 4a                	je     a0 <main+0xa0>
  56:	83 f8 e5             	cmp    $0xffffffe5,%eax
  59:	75 e5                	jne    40 <main+0x40>
				case -27:	
					clear_screen();
					x++;
  5b:	83 c3 01             	add    $0x1,%ebx
		if(k == -1){
			...
			switch (k) {
				case -27:	
					clear_screen();
  5e:	e8 87 03 00 00       	call   3ea <clear_screen>
					blit();
					break;
				case -30:	
					clear_screen();
  ...
  68:	56                   	push   %esi
  69:	53                   	push   %ebx
  6a:	e8 83 03 00 00       	call   3f2 <draw_pixel>
					blit();
  6f:	e8 8e 03 00 00       	call   402 <blit>
					break;
  74:	83 c4 10             	add    $0x10,%esp
	...
	while(1){
		k = getkey();
  77:	e8 66 03 00 00       	call   3e2 <getkey>
		if(k == -1){
  7c:	83 f8 ff             	cmp    $0xffffffff,%eax
  7f:	75 c9                	jne    4a <main+0x4a>
			sleep(1);
  81:	83 ec 0c             	sub    $0xc,%esp
  84:	6a 01                	push   $0x1
  86:	e8 37 03 00 00       	call   3c2 <sleep>
  8b:	83 c4 10             	add    $0x10,%esp
  8e:	eb b0                	jmp    40 <main+0x40>
		} else {
			switch (k) {
  90:	83 f8 e2             	cmp    $0xffffffe2,%eax
  93:	75 ab                	jne    40 <main+0x40>
				...
				case -30:	
					clear_screen();
  95:	e8 50 03 00 00       	call   3ea <clear_screen>
					y--;
  9a:	83 ee 01             	sub    $0x1,%esi
  9d:	eb c4                	jmp    63 <main+0x63>
  9f:	90                   	nop
					x++;
					draw_pixel(x, y, color);
					blit();
				...
				case -28:	
					clear_screen();
  a0:	e8 45 03 00 00       	call   3ea <clear_screen>
					x--;
  a5:	83 eb 01             	sub    $0x1,%ebx
  ...
  aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
				...
				case -29:	
					clear_screen();
  b0:	e8 35 03 00 00       	call   3ea <clear_screen>
					y++;
  b5:	83 c6 01             	add    $0x1,%esi
  b8:	eb a9                	jmp    63 <main+0x63>
  ba:	66 90                	xchg   %ax,%ax
  bc:	66 90                	xchg   %ax,%ax
  be:	66 90                	xchg   %ax,%ax

000000c0 <test_draw_line>:
	return 0;
}
...
int test_draw_line(void) {
  ...
  cc:	6a 00                	push   $0x0
  ce:	6a 00                	push   $0x0
  d0:	e8 25 03 00 00       	call   3fa <draw_line>
	draw_line(50, 0, 50, 50, 8);
  d5:	83 c4 14             	add    $0x14,%esp
  d8:	6a 08                	push   $0x8
  da:	6a 32                	push   $0x32
  dc:	6a 32                	push   $0x32
  de:	6a 00                	push   $0x0
  e0:	6a 32                	push   $0x32
  e2:	e8 13 03 00 00       	call   3fa <draw_line>
	return 0;
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 44f:	f7 f6                	div    %esi
 451:	0f b6 92 d8 07 00 00 	movzbl 0x7d8(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5c8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5cb:	b8 d0 07 00 00       	mov    $0x7d0,%eax
...
free(void *ap)
{
 ...
 651:	a1 98 0a 00 00       	mov    0xa98,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6a7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6a9:	a3 98 0a 00 00       	mov    %eax,0xa98
}
 6ae:	5b                   	pop    %ebx
 6af:	5e                   	pop    %esi
 6b0:	5f                   	pop    %edi
 ...
 6ca:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6cd:	a3 98 0a 00 00       	mov    %eax,0xa98
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 98 0a 00 00    	mov    0xa98,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 73f:	76 3f                	jbe    780 <malloc+0xa0>
    ...
    if(p == freep)
 741:	39 05 98 0a 00 00    	cmp    %eax,0xa98
 ...
 766:	e8 e5 fe ff ff       	call   650 <free>
  return freep;
 76b:	8b 15 98 0a 00 00    	mov    0xa98,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 78c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 78f:	89 15 98 0a 00 00    	mov    %edx,0xa98
      return (void*)(p + 1);
 ...
 7a4:	eb e9                	jmp    78f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7a6:	c7 05 98 0a 00 00 9c 	movl   $0xa9c,0xa98
 7ad:	0a 00 00 
 7b0:	c7 05 9c 0a 00 00 9c 	movl   $0xa9c,0xa9c
 7b7:	0a 00 00 
    base.s.size = 0;
 7ba:	b8 9c 0a 00 00       	mov    $0xa9c,%eax
 7bf:	c7 05 a0 0a 00 00 00 	movl   $0x0,0xaa0
 7c6:	00 00 00 
